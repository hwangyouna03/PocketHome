...
public class Monthly13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.monthly_13);
        ...
        imageButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myintent1 = new Intent(Monthly13.this, MainActivity.class);
        ...
        imageButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myintent1 = new Intent (Monthly13.this, MainMap.class);
                startActivity(myintent1);
        ...
        imageButton3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myintent1 = new Intent( Monthly13.this, Information_word.class);
                startActivity(myintent1);
        ...
        imageButton4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myintent1 = new Intent(Monthly13.this, Community.class);
                startActivity(myintent1);
