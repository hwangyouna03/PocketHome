    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButton2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent myintent1 = new Intent(Monthly8.this, MainActivity.class);
        ...
        imageButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myintent1 = new Intent(Monthly8.this, MainMap.class);
                startActivity(myintent1);
        ...
        imageButton3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myintent1 = new Intent(Monthly8.this, Information_word.class);
                startActivity(myintent1);
        ...
        imageButton4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent myintent1 = new Intent(Monthly8.this, Community.class);
                startActivity(myintent1);
